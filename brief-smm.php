...
$mail->addAddress('smm@soldsite.ru');  // Кому будет уходить письмо 
...
$mail->Subject = 'Заявка на СММ';
$mail->Body    = 'Имя: ' .$name . '<br/>Телефон: ' .$phone . '<br/>Email: ' .$email . '<br/>Сообщение: ' .$text . '<br/><br/>Стратегия: ' .$strategy . '<br/>Ведение сообщества: ' .$leading . '<br/>Продвижение: ' .$promo . '<br/>Комплекс: ' .$complex;
$mail->AltBody = '';
if(!$mail->send()) {
    echo 'Error';
} else {
